...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: 'bg-brand text-white hover:bg-brand-hover focus:ring-brand dark:focus:ring-offset-slate-900',
    ...
    outline: 'border border-slate-300 bg-transparent text-slate-700 hover:bg-slate-50 focus:ring-brand dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800',
  };
